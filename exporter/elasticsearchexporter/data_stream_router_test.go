...
func TestRouteLogRecord(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			ds, err := router.routeLogRecord(encodingContext{resource: pcommon.NewResource(), scope: scope}, pcommon.NewMap())
...
func TestRouteDataPoint(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			ds, err := router.routeDataPoint(encodingContext{resource: pcommon.NewResource(), scope: scope}, pcommon.NewMap())
			require.NoError(t, err)
			assert.Equal(t, tc.want, ds)
		})
	}
...
func TestRouteSpan(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			ds, err := router.routeSpan(encodingContext{resource: pcommon.NewResource(), scope: scope}, pcommon.NewMap())
			require.NoError(t, err)
			assert.Equal(t, tc.want, ds)
		})
	}
