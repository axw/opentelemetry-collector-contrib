...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/xstreamencoding v0.151.0
	...
	go.opentelemetry.io/collector/extension/extensioncapabilities v0.151.1-0.20260501001745-24aecacf1c04
